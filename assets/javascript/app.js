...
function uploadSuccess() {
  uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
    imgSwap(downloadURL);
    //Make it global for later, except you should be able to do faceCall(downloadURL) to pass it in
...
var fear= [14642,14688,15178,15761,14610,16419,17250,17211,16178,16273,11028,14584,17074,11055,13086,17060,11407,11403,17230];  
var anger=  [14065,12870,15597,16041,13222,13070,13861,14087,17122,12107,14306,16100,13202,11368,11239,17135];    
var sadness = [17105,15288,16134,16271,17020,13194,16998,17245,11000,17229,11008,14071,11118,11119,17288,11117,11120,12798,12800,11157,16047];        
var disgust= [15082,15515,15743,16295,17118,16403,17120,17220,17380,13128,14466,17829,12101,11023,14598,13581,17222,13070];          
var surprise= [14602,16108,16333,16942,13940,17184,14782,11798,11872,13535,16992,13072,13198,13652,16405,14360,11010,13899,11053,15567,11034]; 
var neutral= [14598,13282,13395,11145,17196,11291,11006,13731,13162,11012,11013,11014,11020,12562,11021,12792,11026,16202];  
//Happy
...
$(document).ready(function () {
  ...
  function faceCall() {
    ...
    // Performing AJAX POST request FACE API
    $.ajax({
      url: queryURL,
      method: "POST"
    }).then(function (response) {
